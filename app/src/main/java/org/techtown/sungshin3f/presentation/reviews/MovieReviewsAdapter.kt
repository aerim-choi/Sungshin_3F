...
import org.techtown.sungshin3f.databinding.ItemMovieInfromationBinding
import org.techtown.sungshin3f.databinding.ItemMyReviewBinding
import org.techtown.sungshin3f.databinding.ItemReviewBinding
import org.techtown.sungshin3f.databinding.ItemReviewFormBinding
import org.techtown.sungshin3f.domain.model.Movie
import org.techtown.sungshin3f.extension.toAbbreviatedString
    ...
    class MovieInformationViewHolder(private val binding: ItemMovieInfromationBinding) :
        ...
        fun bind(item: Movie) {
            ...
            item.let {
                ...
                binding.relationsTextView.text = "연출 : ${it.director}\n출연진 : ${it.actors}\n가격 : ${it.pay_at}\n장소 : ${it.place_nm}\n" +
                        "최단 경로 : ${it.op_at}"
