...
import org.techtown.sungshin3f.databinding.ActivityRomancewebtoonBinding
import org.w3c.dom.Text
import kotlin.concurrent.thread

class Romancewebtoon : AppCompatActivity() {
    private var mBinding: ActivityRomancewebtoonBinding?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = ActivityRomancewebtoonBinding.inflate(layoutInflater)
    ...
    private fun GenreWebtoonRomInfo(){
        thread{
            val doc= Jsoup.connect("https://comic.naver.com/webtoon/genre?genre=pure")
                .get()
